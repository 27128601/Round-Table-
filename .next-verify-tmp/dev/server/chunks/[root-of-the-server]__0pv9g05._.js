...
"[project]/lib/supabase/proxy-client.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function updateSession(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://lefpytouyoejhcvgfvqa.supabase.co"), ("TURBOPACK compile-time value", "sb_publishable_UGYWlFuv6mnwyqkvk9m2Tw_Gq_mo9Al"), {
        cookies: {
            getAll () {
    ...
    let user = null;
    try {
        const result = await withTimeout(supabase.auth.getUser(), AUTH_CHECK_TIMEOUT_MS, 'Supabase auth check');
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$proxy$2d$client$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/proxy-client.ts [middleware] (ecmascript)");
;
async function proxy(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$proxy$2d$client$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["updateSession"])(request);
}
const config = {
    matcher: [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0pv9g05._.js.map